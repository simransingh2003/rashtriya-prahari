  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[#0e1117]">
        ...
        {/* Hero */}
        <div className="bg-gradient-to-br from-orange-500 to-red-600 text-white py-12 px-4">
          <div className="container mx-auto text-center">
            <div className="text-6xl mb-4">📰</div>
            <h1 className="text-3xl md:text-5xl font-black mb-3 news-serif">ई-पेपर</h1>
            <p className="text-orange-100 text-lg">राष्ट्रीय प्रहरी भारत के डिजिटल संस्करण</p>
          </div>
        </div>
            ...
            <>
              ...
              <div className="mb-10">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-2xl font-black text-gray-900 dark:text-white news-serif">नवीनतम संस्करण</h2>
                </div>
                  ...
                  <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6 text-white">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <h3 className="text-2xl font-black news-serif mt-1">{pdfs[0].title}</h3>
              ...
              {pdfs.length > 1 && (
                <div>
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-1 h-7 bg-orange-500 rounded-full" />
                    <h2 className="text-2xl font-black text-gray-900 dark:text-white news-serif">पिछले संस्करण</h2>
                  </div>
                    ...
                    {pdfs.slice(1).map(pdf => (
                      <div key={pdf.id}
                        ...
                        <div className="flex items-start gap-4">
                          <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/20 rounded-xl flex items-center justify-center text-2xl shrink-0">
                            📄
                          </div>
